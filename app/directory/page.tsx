...
function DirectoryContent() {
  ...
  const uniqueCourses = useMemo(() => {
    const courses = [
      ...new Set(data.map((user) => user.course).filter(Boolean)),
    ];
    return courses.sort();
  }, [data]);
  ...
  const uniqueUserTypes = useMemo(() => {
    const types = [
      ...new Set(data.map((user) => user.userType).filter(Boolean)),
    ];
    return types.sort();
  }, [data]);
  ...
  return (
    <div className="min-h-screen bg-white text-black p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2 bg-white text-black bg-clip-text">
            Directory
          </h1>
        ...
        {/* Search and Filters */}
        <div className="bg-gradient-to-r from-orange-400 to-pink-400 p-1 rounded-lg shadow-none mb-4">
          {/* <CardHeader>
          ...
          <div>
            ...
            <div className="flex items-center justify-between gap-4">
              {/* Search */}
              <div className="relative flex-1 bg-white border border-white/20 rounded-md shadow-none">
                ...
                <Input
                  ...
                  className="pl-10 bg-white border-white/20 text-black outline-none"
                />
              </div>
              ...
              <div className="relative">
                ...
                {/* Filters Popover */}
                {showFilters && (
                  <div className="absolute right-0 mt-2 w-64 bg-[#f0f0f0] rounded-lg shadow-lg z-10">
                    <div className="p-4 space-y-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full p-2 bg-white border border-white/20 rounded-md text-black outline-none"
                        >
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
              {currentData.map((user) => (
                <MagicCard
                  key={user.userId}
                  className="p-1 rounded-2xl border-gray-200 border"
                >
                  <Card
                    key={user.userId}
                    className="bg-[#f0f0f0] transition-colors"
                  >
                              ...
                              <Button
                                ...
                                className={
                                  currentPage === pageNum
                                    ...
                                    : "border-gray-700 text-gray-300 hover:bg-gray-100"
                                }
                              >
                                {pageNum}
                              </Button>
